...
bool OrchDaemon::init()
{
    ...
    TableConnector applStateLogging{m_configDb, CFG_APP_STATE_LOGGING};
    gRouteOrch = new RouteOrch(m_applDb, route_tables, applStateLogging, gSwitchOrch, gNeighOrch, gIntfsOrch, vrf_orch, gFgNhgOrch, gSrv6Orch);
